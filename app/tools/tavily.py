...
**After use:** If you've thoroughly answered the question, reply. If you think
the pages have additional information, use tavily_extract. If you think there
are other pages with more information, use tavily_search again.

**Available parameters:**
- `query` (required): Search query string
- `max_results` (optional): Number of results to return (0-20)
- `days` (optional): Limit results to past N days. Perfect when the user wants
  recent content
- `include_domains` (optional): Search only these domains. Use this
  generously. If you know what domain has the answer, or if you're refining
  your search, this is invaluable.""",
)
...
**After use:** If you've thoroughly answered the question, reply. If you think
there are other pages with more information, use tavily_search.

**Available parameters:**
- `urls` (required): Single URL string or list of URLs (max 20)

**Use cases:** Reading articles verbatim, extracting structured content,
